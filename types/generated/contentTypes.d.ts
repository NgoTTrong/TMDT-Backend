...
export interface ApiCustomerCustomer extends Schema.CollectionType {
  ...
  attributes: {
    clerkUserId: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    receiverAddress: Attribute.String;
    orderStatus: Attribute.Enumeration<
      ['PENDING', 'CONFIRMED', 'DELIVERING', 'RECEIVED', 'CANCEL']
    >;
...
export interface ApiProductionProduction extends Schema.CollectionType {
  ...
  attributes: {
    ...
    listedPrice: Attribute.BigInteger;
    price: Attribute.BigInteger;
    remainingAmount: Attribute.Integer;
